...
#Attempt 3
#Instad of creating a new array new_result in each itration use map!
...
def letter_combinations_3(digits)
  ...
  digits.each_char do |digit|
    ...
    result = result.product(digit_to_letter_map[digit].chars).map(&:join)
  end

  result
end
p letter_combinations_3("23") # Output: ["ad", "ae", "af", "bd", "be", "bf", "cd", "ce", "cf"]
